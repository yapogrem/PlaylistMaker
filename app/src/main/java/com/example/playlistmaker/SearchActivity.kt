...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val trackAdapter=findViewById<RecyclerView>(R.id.recyclerTrack)
        trackAdapter.adapter = TrackAdapter(tracks)
//        trackAdapter.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
